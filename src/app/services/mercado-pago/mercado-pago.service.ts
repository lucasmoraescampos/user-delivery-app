...
export class MercadoPagoService {
  ...
  constructor() {
    ...
    Mercadopago.setPublishableKey('TEST-b01bd26b-0810-457b-8187-54db697eb8eb');
  ...
  private createForm(card: any) {
    ...
    doc_type.setAttribute('value', card.holder_document_type);
    ...
    doc_number.setAttribute('value', card.holder_document_number);
